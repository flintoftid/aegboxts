...
PP_holePitch = 0.01;           // Distance between holes of perforated plate.
PP_holeRadius = 1.5e-3;        // Diameter of holes in perforated plate.
PP_gridSizeY = 20;             // Number of holes in perforated plate in y-direction.
PP_gridSizeZ = 20;             // Number of holes in perforated plate in z-direction.
...
PP_meshSize = 1e-3;           // Mesh size for holes of perforated plate.
...
/////////////////////////////////////////////
// Front panel with perforated plate (PP). //
/////////////////////////////////////////////
...
If ( isPP == 1 )
  ...
  totalGridWidth = ( PP_gridSizeY - 1 ) * PP_holePitch;
  totalGridHeight = ( PP_gridSizeZ - 1 ) * PP_holePitch;  
  gridOriginY = 0.5 * ( EN_width - totalGridWidth );
  gridOriginZ = 0.5 * ( EN_height - totalGridHeight );  
  
  allHoles = {};

  midPointY = 0.5 * EN_width;
  midPointZ = 0.5 * EN_height;
  
  For irow In {1:PP_gridSizeY}
  
    For jcol In {1:PP_gridSizeZ}
    
      centreY = gridOriginY + PP_holePitch * ( irow - 1 ); 
      centreZ = gridOriginZ + PP_holePitch * ( jcol - 1 );
      
      PP_CIRCLE_P_CENTRE = newp;
      Point(PP_CIRCLE_P_CENTRE) = { EN_depth , centreY - PP_holeRadius     , centreZ + PP_holeRadius     , PP_meshSize };
      PP_CIRCLE_P_L = newp;
      Point(PP_CIRCLE_P_L)      = { EN_depth , centreY - 2 * PP_holeRadius , centreZ + PP_holeRadius     , PP_meshSize };
      PP_CIRCLE_P_R = newp;
      Point(PP_CIRCLE_P_R)      = { EN_depth , centreY                     , centreZ + PP_holeRadius     , PP_meshSize };
      PP_CIRCLE_P_U = newp;
      Point(PP_CIRCLE_P_U)      = { EN_depth , centreY - PP_holeRadius     , centreZ + 2 * PP_holeRadius , PP_meshSize };
      PP_CIRCLE_P_D = newp;
      Point(PP_CIRCLE_P_D)      = { EN_depth , centreY - PP_holeRadius     , centreZ                     , PP_meshSize };
      
      PP_CIRCLE_L_LD = newl;
      Circle(PP_CIRCLE_L_LD) = { PP_CIRCLE_P_L , PP_CIRCLE_P_CENTRE , PP_CIRCLE_P_D };
      PP_CIRCLE_L_RD = newl;
      Circle(PP_CIRCLE_L_RD) = { PP_CIRCLE_P_D , PP_CIRCLE_P_CENTRE , PP_CIRCLE_P_R };
      PP_CIRCLE_L_RU = newl;
      Circle(PP_CIRCLE_L_RU) = { PP_CIRCLE_P_R , PP_CIRCLE_P_CENTRE , PP_CIRCLE_P_U };
      PP_CIRCLE_L_LU = newl;
      Circle(PP_CIRCLE_L_LU) = { PP_CIRCLE_P_U , PP_CIRCLE_P_CENTRE , PP_CIRCLE_P_L };
      PP_CIRCLE_LL_F = newll;
      Line Loop(PP_CIRCLE_LL_F) = { PP_CIRCLE_L_LD:PP_CIRCLE_L_LU };
      
      allHoles += PP_CIRCLE_LL_F;
  ...
  PP_S = news;
  Plane Surface(PP_S) = { EN_FLANGE_LL_F , allHoles[] };
  Physical Surface( "PP" ) = { PP_S };  
